...
factor\index{Cholesky factorization} $\mathbf L$$\mathbf P$\index{.l@$\mathbf
...
$\mathbf L$$\mathbf P$\index{.l@$\mathbf L$} instead of an arbitrarily dense
...
If we expect to be computing the change-of-basis $\mathbf E$\index{.e@$\mathbf E$}
...
S_{\textrm{rel}}$\index{.srel@$\mathbf  S_{\textrm  {rel}}$} in an efficient
...
density of $S_{\textrm{rel}}$\index{.srel@$\mathbf  S_{\textrm  {rel}}$}. We may
...
and parameter $C$]{The \abbr{MAP}\index{map@\protect\abbr{MAP}}
  ...
  \index{.c@$C$} from the value of $1$ (leftmost) to the value of $100$
